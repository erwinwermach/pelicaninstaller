WIPE_SERVICES="docker containerd docker.socket nginx apache2 caddy mysql mariadb redis-server cloudflared wings php8.1-fpm php8.2-fpm php8.3-fpm php8.4-fpm php8.5-fpm php-fpm"

wipe_phase() {
  banner "Phase 1/8 - Clean slate wipe"
